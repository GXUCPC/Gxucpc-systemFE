<template>
    <el-card>
        <template #header>
            <span>文章管理</span>
            <el-button type="success" @click="addText" style="float: right;" plain>新建文章</el-button>
        </template>
        <div>
            <el-table :data="tableData" height="620" :show-header="false">
                        ...
                        <div class="list-item-body">
                            <div class="list-item-title">
                                ...
                                <p class="list-item-author">
                                    <el-tag :type="getType(scope.row.data.type)">{{ scope.row.data.type }}</el-tag>
                                </p>
                            </div>
        ...
        <template #footer>
            ...
            <el-pagination background layout="total, prev, pager, next"
                           ...
                           :total="pagingComponent.total" :page-size="pagingComponent.numberPerPage"
